...
const WriteArticle = () => {
  ...
  return (
    ...
    text-slate-700">
      ...
      <input onChange={(e)=>setInput(e.target.value)} value={input} type="text" className="w-full p-2 px-3 mt-3 outline-none text-sm 
      rounded-md border border-gray-300" placeholder="The future of AI in healthcare..." required/>
