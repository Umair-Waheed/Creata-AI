...
const GenerateImages = () => {
   ...
   const imageStyle=["Realistic style", "Anime style", "Cartoon style", "Ghibli Style","Fantasy style", "3D style","Potrait style"];
   
     const [selectedImageStyle,setSelectedImageStyle]=useState('Realistic style');
    ...
    const onSubmitHandler = async (e)=>{
      ...
      try{
        setLoading(true)
        const prompt=`Generate an image of ${input} in this style ${selectedImageStyle}`
  ...
  return (
    ...
    text-slate-700">
      ...
      <textarea onChange={(e)=>setInput(e.target.value)} value={input} row={4} type="text" className="w-full p-2 px-3 mt-3 outline-none text-sm 
        ...
        border-gray-200 min-h-96 '>
            ...
            <div className="flex-1 flex justify-center items-center">
              ...
              text-gray-400">
                ...
                <p>Describe your image and click "Generated image" to get started</p>
              </div>
            </div>
            ):(
