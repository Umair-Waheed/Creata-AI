            ...
            ease-in-out`}>
              ...
              <div className="my-7 w-full">
                ...
                <div>
                  {navItems.map(({to,label,Icon})=>(
                    <NavLink to={to} key={to} end={to === '/ai'} onClick={()=>setSidebar(false)} className={({isActive})=>`px-3.5 py-2.5 flex
              ...
              <div className="w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between"> 
                  <div onClick={openUserProfile} className="flex items-center gap-2 cursor-pointer">
                    ...
                    <div>
                    <h1 className="text-sm font-medium">{user.fullName.substring(0,11)}..</h1>
